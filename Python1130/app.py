...
# 例如:  https://test-1130.herokuapp.com/
@app.route("/") # 指定對應的網址路徑 # 若有人連線到對應路徑, 則執行下列動作 (若出現 404, 不代表無法連上網站, 代表程式不提供該路徑服務)
def home(): # 對應的處理函式
    return render_template("home.html") # 渲染模板
    # return"<h3>Hello Flask</h3><div>這是第1行!</div>" # 回應給前端的訊息 # 可直接使用 JavaScript 語法撰寫

# 例如:  https://test-1130.herokuapp.com/test.php?keyword=關鍵字
...
# lint tool 幫忙檢查程式
# heroku: 伺服器 (https://www.heroku.com/)
# 信箱: a105260028@mail.shu.edu.tw
# 密碼: @shin2yin
